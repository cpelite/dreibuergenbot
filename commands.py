...
class funcommands(commands.Cog):
    ...
    async def watschenwald(self, ctx):
        embed = nextcord.Embed(title="Watschenwald")
    ...
    async def kaiser(self, ctx):
        embed = nextcord.Embed(title="Wichtige Ankündigung")
...
class reichslaender(commands.Cog):
    ...
    async def reichstal(self, ctx):
        embed = nextcord.Embed(title="Informationen über Reichstal")
    ...
    async def werthen(self, ctx):
        embed = nextcord.Embed(title="Informationen über das Königreich Werthen")
    ...
    async def haxagon(self, ctx):
        embed = nextcord.Embed(title="Informationen über das Königreich Haxagon")
    ...
    async def rem(self, ctx):
        embed = nextcord.Embed(title="Informationen über das Königreich Rem")
    ...
    async def stauffen(self, ctx):
        embed = nextcord.Embed(title="Informationen über das Königreich Stauffen")
    ...
    async def hohenburglohe(self, ctx):
        embed = nextcord.Embed(title="Informationen über das Großherzogtum Hohenburg-Lohe")
    ...
    async def bazen(self, ctx):
        embed = nextcord.Embed(title="Informationen über das Großherzogtum Bazen")
    ...
    async def cranach(self, ctx):
        embed = nextcord.Embed(title="Informationen über das Churfürstenthum Cranach")
    ...
    async def geldern(self, ctx):
        embed = nextcord.Embed(title="Informationen über das Erzherzogtum Geldern-Veldoril")
...
class sonstige(commands.Cog):
    ...
    async def reichstag(self, ctx):
        embed = nextcord.Embed(title="Sitzverteilung in der LXII. Sitzungsperiode des Reichstags")
